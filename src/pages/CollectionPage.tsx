...
export default function CollectionPage() {
  ...
  // 年龄段选项
  const ageGroups: { value: string; label: string }[] = [
    { value: '11', label: t.collection.ageGroup11 },
    { value: '12', label: t.collection.ageGroup12 },
    { value: '18', label: t.collection.ageGroup18 },
    { value: '25', label: t.collection.ageGroup25 },
    { value: '45', label: t.collection.ageGroup45 },
    { value: '65', label: t.collection.ageGroup65 },
  ];
